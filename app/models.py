...
class Catalogada(models.Model):
    ...
    grafia_conservadora = models.CharField(max_length=500, verbose_name="Grafia conservadora do nome")
    trecho_nomeacao = models.TextField(max_length=1000, verbose_name="Trecho modernizado de nomeação")
    trecho_voz = models.TextField(max_length=1000, verbose_name="Trecho modernizado da voz")
    detalhamento_perfil = models.TextField(max_length=1000, verbose_name="Detalhamento do perfil")
    ...
    referencia_dmb = models.CharField(max_length=1000, verbose_name="Referência no DMB")
    trecho_bibliografia = models.TextField(max_length=1000, verbose_name="Trecho de menção na bibliografia")
    fonte_bibliografia = models.TextField(max_length=1000, verbose_name="Fonte da menção na bibliografia")

    #interno
    responsavel_catalogacao = models.CharField(max_length=500, verbose_name="Responsabilidade pela catalogação")
...
class Documento(models.Model):
    ...
    descricao_conteudo_documento = models.TextField(max_length=5000, verbose_name="Descrição do conteúdo do documento")
    descricao_materia_documento = models.TextField(max_length=5000, verbose_name="Descrição material do documento")
    ...
    conservadora_menor_escrita = models.CharField(max_length=500, verbose_name="Forma conservadora da unidade administrativa menor do local de escrita")
    unidade_intermediaria_escrita = models.CharField(max_length=1000, verbose_name="Unidade administrativa intermediária de escrita")
    conservadora_intermediaria_escrita = models.CharField(max_length=1000, verbose_name="Forma conservadora da unidade administrativa intermediária do local de escrita")
    unidade_maior_escrita = models.CharField(max_length=1000, verbose_name="Unidade administrativa maior de escrita")
    conservadora_maior_escrita = models.CharField(max_length=1000, verbose_name="Forma conservadora da unidade administrativa maior do local de escrita")
    point_escrita = models.CharField(max_length=100, verbose_name="Point de georreferenciamento do local de escrita")
    unidade_menor_morada = models.CharField(max_length=1000, verbose_name="Unidade administrativa menor de morada")
    conservadora_menor_morada = models.CharField(max_length=1000, verbose_name="Forma conservadora da unidade administrativa menor de morada")
    unidade_intermediaria_morada = models.CharField(max_length=1000, verbose_name="Unidade administrativa intermediária de morada")
    conservadora_intermediaria_morada = models.CharField(max_length=1000, verbose_name="Forma conservadora da unidade administrativa intermediária de morada")
    unidade_maior_morada = models.CharField(max_length=1000, verbose_name="Unidade administrativa maior de morada")
    conservadora_maior_morada = models.CharField(max_length=1000, verbose_name="Forma conservadora da unidade administrativa maior de morada")
    ...
    autoria_edicao_conservadora = models.TextField(max_length=3000, verbose_name="Autoria da edição filológica conservadora")
    autoria_edicao_modernizada = models.TextField(max_length=3000, verbose_name="Autoria da edição filológica modernizada")
    responsabilidade_revisao_parcial = models.TextField(max_length=3000, verbose_name="Responsabilidade pela revisão da edição parcial")
    data_revisao = models.CharField(max_length=15, verbose_name="Data da revisão mais recente da edição parcial")
    ligacao_edicao_filologica = models.CharField(max_length=3000, verbose_name="Ligação para a edição filológica")
    ...
    gx_media_links = models.CharField(max_length=5000, verbose_name="gx_media_links")
    # interno
    ...
    responsavel_documento = models.CharField(max_length=1000, verbose_name="Responsabilidade pelo documento")
